...
## import data
df_input <- read_csv(
  here::here("output", "cohorts", "input_1_stppop_v2.csv"),
  col_types = cols(
...
ggsave(
  ...
  filename="plot_stppop_map_v2.png", path=here::here("output", "plots"),
  units = "cm",
  height = 10,
  width = 10
)
...
ggsave(
  ...
  filename="plot_stppop_bar_names_v2.png", path=here::here("output", "plots"),
  units = "cm",
  height = 15,
  width = 15
)
