...
Now that we have a dummy dataset, we can begin to develop and test our analysis code in R. We just want to import the dataset, count the number of STPs, and output to a file. These steps are outlined code-block below.
...
This is just dummy data but we'll be able to simply repeat the steps above on the real dataset to see how this map looks for real.
