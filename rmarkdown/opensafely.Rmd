---
title: "OpenSAFELY platform demonstration"
...
Got to the [research template reposity]https://github.com/opensafely/research-template and click `Use this template`. Follow this instructions [here](https://docs.opensafely.org/en/latest/project_setup/).
...
```{r stppop, , class.source = "fold-hide"}
## import libraries
library('tidyverse')
library('sf')
## import data
...
```{r stppop.map, class.source = "fold-hide"}
...
```{r stppop.bar, class.source = "fold-hide"}
...
This is just dummy data. We'll be able to easily rerun the code above on the real dataset to see how this map looks for real. For this, we use the OpenSAFELY Job Runner. 
...
[![](../released-ouput/plots/plot_stppop_bar.png "registration count by STP"){width="50%"}](https://github.com/opensafely/os-demo-research/blob/master/released-ouput/plots/plot_stppop_bar.png)
...
The study definition for this task is available at  [`/analysis/study_definition_2_deaths.py`](https://github.com/opensafely/os-demo-research/blob/master/analysis/study_definition_2_deaths.py). 
...
[![](../released-ouput/plots/plot_deaths.png "covid-related deaths"){width="50%"}](https://github.com/opensafely/os-demo-research/blob/master/released-ouput/plots/plot_deaths.png)
...
The entire study definition is available at [`/analysis/study_definition_3_activity.py`](https://github.com/opensafely/os-demo-research/blob/master/analysis/study_definition_3_activity.py), and we'll pick out some key parts. 
...
[![](../released-ouput/plots/plot_each_cholesterol_stp.png)](https://github.com/opensafely/os-demo-research/blob/master/released-ouput/plots/plot_each_cholesterol_stp.png)

and for INR:

[![](../released-ouput/plots/plot_each_inr_stp.png){width="50%"}](https://github.com/opensafely/os-demo-research/blob/master/released-ouput/plots/plot_each_inr_stp.png)
...
[![](../released-ouput/plots/plot_quantiles_cholesterol_stp.png){width="50%"}](https://github.com/opensafely/os-demo-research/blob/master/released-ouput/plots/plot_quantiles_cholesterol_stp.png)


and for INR:
[![](../released-ouput/plots/plot_quantiles_inr_stp.png){width="50%"}](https://github.com/opensafely/os-demo-research/blob/master/released-ouput/plots/plot_quantiles_inr_stp.png)
